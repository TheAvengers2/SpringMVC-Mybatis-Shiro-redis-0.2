(function() {
    ...
    var db = {
        ...
        loadData: function(filter) {
			...
			$.ajax({
				url: '/shiro.demo/demo/jsgrid.json',
				dataType: 'json',
				success: function(data){
					db.clients = data.results;
					deferred.resolve(db.clients);
					pros = $.grep(db.clients, function(client) {
						var res = (!filter.Name || client.Name.indexOf(filter.Name) > -1)
